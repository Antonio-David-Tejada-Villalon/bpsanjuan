...
import { getLibrary, toggleLibraryLike, addLibraryComment } from '../api/libraries';
...
export default function BibliotecaDetalle() {
  ...
  return (
    <div className="section container">
      ...
      <div className="card" style={{ marginTop: 24 }}>
        <div className="card-body">
          <h3 className="lib-section-title">Comentarios ({library.comments?.length ?? 0})</h3>
          <form onSubmit={handleComment} className="comment-form">
            ...
            <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
              ...
              {!publicUser && <GoogleLoginBtn className="btn btn-sm btn-outline" />}
            </div>
          </form>

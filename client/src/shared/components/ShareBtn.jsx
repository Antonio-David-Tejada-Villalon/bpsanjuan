...
import { trackShare } from '@/features/analytics/api/analyticsApi';
  ...
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.736-8.836L1.254 2.25H8.08l4.259 5.631 5.905-5.631zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
      </svg>
    ),
    getUrl: (url, title) => `https://x.com/intent/tweet?text=${encodeURIComponent(title)}&url=${encodeURIComponent(url)}`,
  },
];
...
export default function ShareBtn({ url, title, resourceId, resourceType, resourceName }) {
  ...
  const copyLink = async () => {
    try {
      ...
      window.prompt('Copiá el enlace:', fullUrl);
    }
  };

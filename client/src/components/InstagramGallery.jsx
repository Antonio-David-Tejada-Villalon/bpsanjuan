...
export default function InstagramGallery() {
  ...
  useEffect(() => {
    fetch(`${API}/instagram/feed`)
      ...
      .then(data => {
        ...
        else setError('No se pudo cargar el feed.');
      })
  ...
  return (
    <section className="ig-gallery-section section container">
      ...
      {loading && (
        <div className="ig-gallery-grid ig-gallery-grid--skeleton">
              ...
              >
                ...
                <div className="ig-item-overlay">
                  {post.media_type === 'VIDEO' && (
                    <svg className="ig-item-play" width="32" height="32" viewBox="0 0 24 24" fill="white">
                      <path d="M8 5v14l11-7z"/>
                    </svg>
                  )}
                  {post.media_type === 'CAROUSEL_ALBUM' && (
                    <svg className="ig-item-carousel" width="22" height="22" viewBox="0 0 24 24" fill="white">

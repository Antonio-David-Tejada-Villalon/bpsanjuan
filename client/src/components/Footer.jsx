...
const DEV = {
  name: 'Antonio David Tejada Villalón',
  title: 'Web Designer & Developer',
  email: '4vdel777@gmail.com',
  phone: '+5492644145337',
};
    ...
    <footer className="footer">
      <div className="container footer-inner">
        ...
        <div className="footer-dev">
          ...
          <strong className="footer-dev-name">{DEV.name}</strong>
          <span className="footer-dev-title">{DEV.title}</span>
          <div className="footer-dev-contact">
            <a
              href={`mailto:${DEV.email}`}
              className="footer-dev-icon"
              title={DEV.email}
              aria-label={`Enviar email a ${DEV.name}`}
            >
            ...
            <a
              href={`https://wa.me/${DEV.phone.replace('+', '')}`}
              target="_blank"
              rel="noopener noreferrer"
              className="footer-dev-icon"
              title={`WhatsApp ${DEV.phone}`}
